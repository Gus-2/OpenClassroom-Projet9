...
public class HouseTypeEntry implements BaseColumns {
    ...
    static final String CONTENT_HOUSE_TYPE = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_HOUSE_TYPE;
    static final String CONTENT_ITEM_HOUSE_TYPE = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_HOUSE_TYPE;
