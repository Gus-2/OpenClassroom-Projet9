...
public class RealEstateAgentEntry implements BaseColumns {
    ...
    static final String CONTENT_REAL_ESTATE_AGENT = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_REAL_ESTATE_AGENT;
    static final String CONTENT_ITEM_REAL_ESTATE_AGENT = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_REAL_ESTATE_AGENT;
