...
public class HousePointOfInterestEntry implements BaseColumns
{
    ...
    public static final String CONTENT_HOUSE_POINT_OF_INTEREST = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_HOUSE_POINT_OF_INTEREST;
    public static final String CONTENT_ITEM_HOUSE_POINT_OF_INTEREST = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_HOUSE_POINT_OF_INTEREST;
