...
public class TypePointOfInterestEntry implements BaseColumns {
    ...
    public static final String CONTENT_TYPE_POINT_OF_INTEREST = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_TYPE_POINT_OF_INTEREST;
    public static final String CONTENT_ITEM_TYPE_POINT_OF_INTEREST = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_TYPE_POINT_OF_INTEREST;
