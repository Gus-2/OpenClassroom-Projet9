...
public class RoomNumberEntry implements BaseColumns {
    ...
    static final String CONTENT_ROOM_NUMBER = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_ROOM_NUMBER;
    static final String CONTENT_ITEM_ROOM_NUMBER = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_ROOM_NUMBER;
