...
public class RoomEntry implements BaseColumns {
    ...
    static final String CONTENT_ROOM = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_ROOM;
    static final String CONTENT_ITEM_ROOM = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_ROOM;
