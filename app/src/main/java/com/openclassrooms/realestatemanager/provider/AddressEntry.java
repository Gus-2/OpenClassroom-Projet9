...
public class AddressEntry implements BaseColumns {
    ...
    public static final String CONTENT_ADDRESS = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_ADDRESS;
    public static final String CONTENT_ITEM_ADDRESS = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_ADDRESS;
